/**
 * Custom hook used to detect media screen size
 *
...
const useMediaHooks = (
  ...
  useEffect(() => {
    ...
    const mediaQueryObject: MediaQueryList =
      ...
      typeof window === "undefined" ? mockMediaQueryObject : window.matchMedia(convertedQuery); // Returns a MediaQueryList object if matched with rawQuery
