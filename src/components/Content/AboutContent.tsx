  ...
  return (
    <StyledContentContainer id="about-content">
      ...
      <p>
        ...
        <PreviewLink
          url="https://www.seattleu.edu/scieng/computer-science/"
      ...
      <p>
        ...
        solution I experience during my learning journey. It helps me know what the problem is and
        how I solve it.
      </p>
      <p>
        I also want to share what I know with everyone who is having the same problem as I have
        before. So they learn another solution to solve the problem, or they give me some feedback
        to correct or improve my solution.
      </p>
      <p>
        You can also learn how I write this website via this{" "}
        <PreviewLink url="https://richardnguyen99.github.io/therichardblog/" text="Github link" />.
      </p>
      <p></p>
