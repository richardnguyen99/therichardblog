...
Gatsby basically takes all your pages, data and contents from either your codebase or external sources, and compile all of them into static assets. This allows you to deploy quickly and easily using other
